...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      />
      <BlurFade>
        <div className="flex flex-col justify-start sm:justify-center md:justify-start items-center h-[70vh] 2xl:h-[60vh] min-h-[500px] md:min-h-[400px] max-h-[800px] 2xl:max-h-[700px] m-4 lg:mx-10 gap-4">
          <Image
            src="/self.jpeg"
            alt="Foto de William Pereira sorrindo enquanto olha para a câmera. William é um homem, com rosto oval."
            width={1188}
            height={1232}
          ...
          <div className="flex flex-row justify-center md:w-2/3">
            <span className="text-center mt-6 xl:mt-1 text-3xl sm:text-4xl md:text-5xl font-roboto font-bold">
